...
public class SinistreServiceImpl implements SinistreService {
	...
	public Sinistre convertToEntity(SinistreDto sinistreDto) {
		return new Sinistre(sinistreDto.getContractId(), sinistreDto.getUserId(), sinistreDto.getCategory(),
				sinistreDto.getDate());
	}

	@Override
	public SinistreDto convertToDto(Sinistre sinistre) {
		SinistreDto sinistreDto = new SinistreDto(sinistre.getContractId(), sinistre.getUserId(),
				sinistre.getCategory(), sinistre.getDate());
