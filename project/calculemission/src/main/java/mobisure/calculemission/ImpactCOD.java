...
public class ImpactCOD {
	...
	public double getEmission(int transport, double kilometers) {
		...
		String url = "https://impactco2.fr/api/v1/transport?km=" + (int) kilometers + "&displayAll=0&transports=" + transport + "&ignoreRadiativeForcing=0&occupencyRate=1&includeConstruction=0&language=fr";
